...
//	  var m = 10; // Hata: 'var' is not allowed here // var nesne deðiþkeni olamaz. yerel olabilir.
	
//	 private static var b = true; // var sýnýf deðiþkeni olamaz. yerel olabilir.

	
	public static void main(String[] args) {
		
//		var i;	// Cannot use 'var' on variable without initializer //atama yapmadan kullanamazsýn
